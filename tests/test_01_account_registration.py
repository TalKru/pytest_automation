...
def test_correct_account_registration(driver: webdriver, wait: WebDriverWait, request):
    try:
        ...
        print(f'random mail used: {rand_email}')
...
def test_missing_agreement_checkbox_error_msg(driver: webdriver, wait: WebDriverWait, request):
    try:
        home_page_obj = HomePage(driver, wait)
        register_page_obj = RegisterPage(driver, wait)
...
def test_passwords_mismatch_on_registration(driver: webdriver, wait: WebDriverWait, request):
    try:
        home_page_obj = HomePage(driver, wait)
        register_page_obj = RegisterPage(driver, wait)
